                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title"> {{ \Illuminate\Support\Str::limit(strip_tags($order->paper_type), 35) ?? '-' }} </h3>
                        ...
                        <div class="card-body">
                            ...
                            <dl class="row  mb-0">
                                ...
                                <dd class="col-sm-9 mb-0">{{$order->paper_type ?? '-'}}</dd>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($order->invoice->status_id == 4)
                                                <a href="{{route('invoice', ['reference' => $order->invoice->ref_no] )}}"
                        ...
                        <div class="card-body">
                            <div style="margin-left: 10px">
                                ...
                                @if ($files)
                                    ...
                                    <a href="{{ url('storage/app/public/'.$file->file_path) }}"  target="_blank">{{ trim($file->file_path,'uploads/') }}</a>
                                    <br>

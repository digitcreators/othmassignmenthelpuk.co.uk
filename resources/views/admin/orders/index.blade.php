            ...
            $('#order-data-table').DataTable( {
                ...
                "columns"   : [
                    ...
                    },
                    {
                        "data": "amount_pretty",
                        "render": function (data, type, row) {
                            return '<div class="d-flex justify-content-between px-3 bg-light py-2"><span class="font-weight-bold">'+ data +'</span><span class="badge '+row.invoice.status.css_class+' mt-1">'+row.invoice.status.name+'</span></div>';
                        }
                    },

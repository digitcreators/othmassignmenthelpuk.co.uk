                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route("admin.setting.update", [$setting->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control {{ $errors->has('twitter_link') ? 'is-invalid' : '' }}" type="text" name="twitter_link" id="twitter_link" value="{{ old('twitter_link', $setting->twitter_link) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control {{ $errors->has('whatsapp_link') ? 'is-invalid' : '' }}" type="text" name="whatsapp_link" id="whatsapp_link" value="{{ old('whatsapp_link', $setting->whatsapp_link) }}" required>
